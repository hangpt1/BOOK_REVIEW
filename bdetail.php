   ...
   <div class="review-detail-container">
        <div class="review-header">
            ...
            <div class="info-container">
                <p class="book-title">Tên Cuốn Sách: <span id="book-title">Ai lấy miếng pho mát của tôi</span></p>
        ...
        <div class="rv-section">
            <form action="./writerv.php" method="POST" id="post-form">
                <a href=""><input type="submit" value="Đăng bài review cuốn sách này" class="submit"></a>
            </form>
        </div>
